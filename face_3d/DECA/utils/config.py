...
cfg.pretrained_modelpath = 'pretrain_models/face_lib/face_3d/DECA/deca_model.tar'
cfg.output_dir = ''
...
cfg.model.flame_model_path = 'pretrain_models/face_lib/face_3d/FLAME/generic_model.pkl'
cfg.model.flame_lmk_embedding_path = 'pretrain_models/face_lib/face_3d/FLAME/landmark_embedding.npy'
