...
"""
from https://github.com/modelscope/modelscope/blob/master/modelscope/models/cv/image_face_fusion/network/bfm.py
"""
import os
...
class ParametricFaceModel():
    ...
    def compute_shape(self, id_coeff, exp_coeff):
        ...
        id_part = torch.einsum('ij,aj->ai', torch.tensor(self.id_base), id_coeff)
        exp_part = torch.einsum('ij,aj->ai', torch.tensor(self.exp_base), exp_coeff)
    ...
    def compute_texture(self, tex_coeff, normalize=True):
        ...
        face_texture = torch.einsum('ij,aj->ai', torch.tensor(self.tex_base),
