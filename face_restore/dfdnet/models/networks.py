...
class VGGFeat(torch.nn.Module):
    ...
    """
    def __init__(self, weight_path='./pretrain_models/face_restore/dfdnet/weights/vgg19.pth'):
        super().__init__()
...
class UNetDictFace(nn.Module):
    def __init__(self, ngf=64, dictionary_path='./pretrain_models/face_restore/dfdnet/DictionaryCenter512'):
        super().__init__()
